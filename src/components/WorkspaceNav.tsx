...
export function WorkspaceNav({ projectId, active }: { projectId: string; active: 'overview' | 'world' | 'characters' | 'relationships' | 'locations' | 'objects' | 'state' }) {
  const items = [['overview', 'Overview', ''], ['world', 'World', '/world'], ['characters', 'Characters', '/characters'], ['relationships', 'Relationships', '/relationships'], ['locations', 'Locations', '/locations'], ['objects', 'Objects', '/objects'], ['state', 'State', '/state']] as const;
