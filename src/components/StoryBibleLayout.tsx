...
export function StoryBibleHeader({ projectId, title, eyebrow, copy, active }: { projectId: string; title: string; eyebrow: string; copy: string; active: 'world' | 'characters' | 'relationships' | 'locations' }) {
